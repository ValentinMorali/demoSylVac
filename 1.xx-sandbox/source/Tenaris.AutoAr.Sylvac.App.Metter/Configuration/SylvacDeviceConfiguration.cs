...
namespace Tenaris.AutoAr.Sylvac.Library.Metter.Model
{
    ...
    /// 
    /// </summary>
    public class SylvacDeviceConfiguration : ConfigurationSection, IXmlSerializable
    {
        #region ViewConfiguration Properties
        /// <summary>
        /// 
        /// </summary>
        public static SylvacDeviceConfiguration Settings
        {
            get
            {
                return (SylvacDeviceConfiguration)ConfigurationManager.GetSection("SylvacDeviceConfiguration");
            }
            set
            {
                ConfigurationManager.RefreshSection("SylvacDeviceConfiguration");
            }
        }
        #endregion
        ...
        [ConfigurationProperty("Period", IsRequired = true, DefaultValue = 250)]
        public int Period
        {
            get
            {
